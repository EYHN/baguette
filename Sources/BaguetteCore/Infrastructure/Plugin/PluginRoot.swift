...
///   3. Sidecar resource bundle next to the executable —
...
enum PluginRoot {
    ...
    static let sourceTreePath = "Sources/BaguetteCore/Resources/Plugins"
    ...
    static func sidecarRoot(nextTo directory: URL) -> URL? {
        ...
        guard let resources = bundleNames.lazy.compactMap({ name -> URL? in
